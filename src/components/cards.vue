    ...
    <div :style="[darkMode ? $store.state.dark : { color: 'black' }]" class="card-1">
      ...
      <div class="cards">
        ...
        <div class="todayDetails">
          ...
          </h3><h3 style="color : #F7CD5D;">
           Sunrise - 
           {{sunrise}}AM</h3>
          <h3 style="color:#ec544c;">
           Sunset - 
           {{sunset}}PM</h3>
        </div>
      </div>
...
watch:{
  ...
  daily:function(){
    this. sunrise = unixTimestampFormat(this.daily.sys.sunrise);
    this.sunset = unixTimestampFormat(this.daily.sys.sunset);
